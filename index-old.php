									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												...
												$sql = "SELECT c.name, COUNT(a.team) AS teamcount, COUNT(CASE WHEN b.status=0 THEN 1 END) AS present FROM employee a
												LEFT OUTER JOIN attendance b ON a.id = b.emp_id
												LEFT OUTER JOIN team c ON a.team = c.id
